...
if (isset($_POST['update_username'])) {
    ...
    mysqli_query($conn, "UPDATE users SET username='$new_username' WHERE username='$customer'");
    $_SESSION['user'] = $new_username; // Update session
    $customer = $new_username;
...
if (isset($_POST['upload_image']) && isset($_FILES['profile_image'])) {
    ...
    $filename = $customer . '.' . $ext; // New image filename
    ...
    if (move_uploaded_file($file['tmp_name'], $target)) {
        mysqli_query($conn, "UPDATE users SET profileimage='$filename' WHERE username='$customer'");
...
<body>
<?php include 'cu_header.php'; ?> <!-- Common customer header -->
<div class="profile-container">
    ...
    <form method="POST" class="delete-account" onsubmit="return confirm('Are you sure you want to delete your customer account?');">
