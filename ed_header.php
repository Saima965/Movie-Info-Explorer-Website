...
<header class="header">
  ...
  <!-- Navigation Links -->
  <nav class="navbar">
     <a href="editor_dashboard.php">All Movies</a>
    <a href="editor_add_pending_movies.php">Add & Pending Movies</a>
     <a href="editor_ratings_overview.php">Ratings Overview</a>
    <a href="editor_watchlist_stats.php">Watchlist Stats</a>
    <a href="editor_notification.php">Notifications</a>
  </nav>
  
  <div class="icons">
    <!-- Welcome message beside profile icon -->
    <span class="welcome-msg">Welcome, 
      <?php echo isset($_SESSION['user']) ? htmlspecialchars($_SESSION['user']) : 'editor'; ?>
    </span>
    ...
    <div id="login-btn">
      ...
      // If editor has uploaded a profile image, use it
      if(isset($_SESSION['user'])){
          $editorUser = $_SESSION['user'];
          $query = mysqli_query($conn, "SELECT profileimage FROM users WHERE username='$editorUser'");
  ...
  <form class="search-form" method="GET" action="">
    <!-- Input is always empty by default; JS will handle clearing -->
  ...
  <form action="#" class="profile">
    <a href="editor_profile.php" class="box">Profile</a><br>
    <a href="logout.php" class="box" style="color:#fff;">Logout</a>
  </form>
</header>
