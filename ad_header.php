...
<header class="header">
  ...
  <div class="icons">
    ...
    <span class="welcome-msg">Welcome, 
      <?php echo isset($_SESSION['user']) ? htmlspecialchars($_SESSION['user']) : 'Admin'; ?>
    </span>
    ...
    <div id="login-btn">
      ...
      // If admin has uploaded a profile image, use it
      if(isset($_SESSION['user'])){
          $adminUser = $_SESSION['user'];
          $query = mysqli_query($conn, "SELECT profileimage FROM users WHERE username='$adminUser'");
  ...
  <form action="#" class="profile">
    <a href="admin_profile.php" class="box">Profile</a><br>
